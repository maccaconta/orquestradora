...
class ServiceFormularioPendencia:

    @staticmethod
    async def serv_formulario_pendencia(param, service) -> dict:
        """
        nome: serv_formulario_pendencia
        :return: ...
        """
        ...
        try:
            url_ = service.get("url") + "/transferencia/" + \
                service.get("canal") + "/proprietario/"
