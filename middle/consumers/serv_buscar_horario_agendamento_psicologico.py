...
class ServiceBuscarHorarioAgendamentoPsicologico:

    @staticmethod
    async def serv_buscar_horario_agendamento_psicologico(param, service) -> dict:
        """
        ...
        url_ = service.get("url") + "/divisao-equitativa/" + \
               service.get("canal") + "/horarios-psicologo-por-data/"
