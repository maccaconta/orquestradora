...
class ServiceRealizarAgendamentoMedicoPsicologico:

    @staticmethod
    async def servRealizarAgendamentoMedicoPsicologico(param, service) -> dict:
        """
        ...
        url_ = service.get("url") + "/divisao-equitativa/" + \
               service.get("canal") + "/agendar-exames/"
